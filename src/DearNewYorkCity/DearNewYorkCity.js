            ...
            <div className="DearNewYorkCity">
                <div className="DearNYC-description">
                    <p className="Carousel-description">
                        "Dear New York is my small protest against the epidemic of overbuilding, destroying mom and pop stores, and the daily erosion of the human scale and community of New York we used to know and love. These street photographs were taken in the 70's and 80's. The letters are more recently-written laments. In those days, I was excited to get my camera and hit the streets, when I had time off from my studio photography that helped fund my passion. Every block, every street offered hope of seeing something exciting, and it was all a total adventure of being an urban explorer." - Gene, 2016
                    </p>
                    <br/><br/><br/>
                </div>
                <Carousel
